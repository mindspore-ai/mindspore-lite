...
.. py:class:: mindspore_lite.MultiModelRunner()
    ...
    .. py:method:: def build_from_file(model_path, model_type, context=None, config_path="", config_dict: dict = None)
    ...
    .. py:method:: def get_model_executor()

        获取runner创建的ModelExecutor对象

        返回:ModelExecutor对象的列表
