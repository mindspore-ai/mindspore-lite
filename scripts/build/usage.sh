...
usage()
{
  ...
  echo "              [-I arm64|arm32|x86_64] [-A on|off] [-O lite_boost] [-S on|off] \\"
  ...
  echo "    -O Build optional target, option: lite_boost (build mindspore-lite/lite_boost/build.sh), default: off"
