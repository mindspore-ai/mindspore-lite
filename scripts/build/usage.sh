...
usage()
{
  ...
  echo "              [-I arm64|arm32|x86_64] [-A on|off] [-O lite_boost|lite_llm] [-S on|off] \\"
  ...
  echo "    -O Build optional target, option: lite_boost (build mindspore-lite/lite_boost/build.sh) | lite_llm (build mindspore-lite/lite_llm/build.sh, OHOS cross-compile when OHOS_NDK is set), default: off"
