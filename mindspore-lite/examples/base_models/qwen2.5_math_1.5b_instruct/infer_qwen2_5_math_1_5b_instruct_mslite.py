...
# ============================================================================
"""
Infer Qwen2.5-Math-1.5B-Instruct with MindSpore Lite using split MindIR (prefill + decode).
"""
...
class Qwen215BInferencer:
    """Qwen2.5-Math-1.5B-Instruct inferencer with MindSpore Lite."""
    ...
    def _prepare_inputs(self, text: str, max_length: int):
        """Prepare inputs for Qwen2.5-Math-1.5B-Instruct inference."""
    ...
    def generate(
        ...
        """Generate text using Qwen2.5-Math-1.5B-Instruct."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Qwen2.5-Math-1.5B-Instruct Inference with MindSpore Lite (prefill + decode)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--tokenizer", type=str, default="./Qwen2.5-Math-1.5B-Instruct", help="Tokenizer path"
    )
