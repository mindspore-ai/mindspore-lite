...
# ============================================================================
"""BEVFormer MindSpore Lite inference (numpy-only, no torch)."""
...
class BEVFormerMsLite:
    """BEVFormer MindSpore Lite inference."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="BEVFormer MindSpore Lite inference")
...
def main():
    ...
    net = BEVFormerMsLite(args.model, args.device, args.device_id)
