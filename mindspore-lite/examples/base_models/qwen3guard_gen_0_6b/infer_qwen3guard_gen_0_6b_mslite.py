...
"""
Infer Qwen3Guard-Gen-0.6B with MindSpore Lite using MindIR model.
"""
...
class Qwen3Inferencer:
    """
    Qwen3Guard-Gen-0.6B inferencer using split MindIR (prefill + decode).
    """
...
def main():
    """
    Main function for Qwen3Guard-Gen-0.6B inference with MindSpore Lite.
    """
    parser = argparse.ArgumentParser(
        description="Qwen3Guard-Gen-0.6B Inference with MindSpore Lite using split MindIR (prefill + decode)"
    )
    parser.add_argument(
        "--prefill-model",
        type=str,
        required=True,
        help="Path to qwen3guard_gen_llm_prefill.mindir",
    )
    parser.add_argument(
        "--decode-model",
        type=str,
        required=True,
        help="Path to qwen3guard_gen_llm_decode.mindir",
    )
    parser.add_argument(
        "--tokenizer",
        type=str,
        default="Qwen/Qwen3Guard-Gen-0.6B-Instruct",
