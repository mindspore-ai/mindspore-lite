...
# ============================================================================
"""Export stabilityai/sv4d to ONNX for MindSpore Lite.

SV4D is an image-to-video diffusion model (fixed 1024x576, 25 frames). The
...
(the SV4D default, ``unet.config.num_frames``).
"""
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Export sv4d components "
                    "to ONNX")
    ...
    parser.add_argument("--resolution", type=int, nargs=2,
                        ...
                        help="Output video frame resolution (fixed for SVD). "
                             "SV4D default is 576 1024 (16:9).")
    parser.add_argument("--num-frames", type=int, default=25,
                        help="Number of video frames (SV4D default 25).")
...
def main():
    ...
    print(f"SV4D ONNX export: resolution={height}x{width}, "
