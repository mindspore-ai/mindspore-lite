...
# ============================================================================
"""End-to-end accuracy alignment for SV4D: HF diffusers vs MindSpore Lite.
...
initial latents, scheduler/guidance settings):
  ...
  2. MindSpore Lite pipeline on Ascend (the internals of
     ``infer_sv4d_mslite.SvdInferencer``, driven here so the shared
...
from infer_sv4d_mslite import SvdInferencer
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="SV4D HF vs MSLite alignment")
