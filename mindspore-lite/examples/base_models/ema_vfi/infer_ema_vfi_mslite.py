#!/usr/bin/env python3
"""EMA_VFI MindSpore Lite 推理脚本(MindIR)。
...
class EmaVfiMsliteInferencer:
    """EMA_VFI MindSpore Lite 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="EMA_VFI MindSpore Lite 推理(MindIR)")
    ...
    p.add_argument("--output", type=str, default="./ema_vfi_mid_mslite.png")
...
def main():
    ...
    infer = EmaVfiMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
