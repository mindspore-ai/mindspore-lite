#!/usr/bin/env python3
"""EMA_VFI ONNXRuntime 推理脚本(精度基准 ground truth): 两帧 -> 中点中间帧。"""
...
class EmaVfiOnnxInferencer:
    """EMA_VFI ONNXRuntime 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="EMA_VFI ONNXRuntime 推理")
    ...
    p.add_argument("--output", type=str, default="./ema_vfi_mid_onnx.png")
...
def main():
    ...
    infer = EmaVfiOnnxInferencer(args.onnx, device=args.device)
