...
def _parse_args():
    ...
    p.add_argument("--output", type=str, default="./toflow_sr_mslite.png")
...
def main():
    ...
    infer = ToflowMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
