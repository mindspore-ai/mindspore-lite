#!/usr/bin/env python3
"""AMT_L MindSpore Lite 推理脚本(MindIR)。
...
class AmtLMsliteInferencer:
    """AMT_L MindSpore Lite 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="AMT_L MindSpore Lite 推理(MindIR)")
    ...
    p.add_argument("--output", type=str, default="./amt_l_mid_mslite.png")
...
def main():
    ...
    infer = AmtLMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
