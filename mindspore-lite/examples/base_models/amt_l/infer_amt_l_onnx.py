#!/usr/bin/env python3
"""AMT_L ONNXRuntime 推理脚本(精度基准 ground truth): 两帧 -> 中点中间帧。"""
...
class AmtLOnnxInferencer:
    """AMT_L ONNXRuntime 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="AMT_L ONNXRuntime 推理")
    ...
    p.add_argument("--output", type=str, default="./amt_l_mid_onnx.png")
...
def main():
    ...
    infer = AmtLOnnxInferencer(args.onnx, device=args.device)
