#!/usr/bin/env python3
"""VFIFormer MindSpore Lite 推理脚本(MindIR)。
...
class VFIFormerMsliteInferencer:
    """VFIFormer MindSpore Lite 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="VFIFormer MindSpore Lite 推理(MindIR)")
    ...
    p.add_argument("--output", type=str, default="./vfiformer_mid_mslite.png")
...
def main():
    ...
    infer = VFIFormerMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
