#!/usr/bin/env python3
"""VFIFormer ONNXRuntime 推理脚本(精度基准 ground truth): 两帧 -> 中点中间帧。"""
...
class VFIFormerOnnxInferencer:
    """VFIFormer ONNXRuntime 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="VFIFormer ONNXRuntime 推理")
    ...
    p.add_argument("--output", type=str, default="./vfiformer_mid_onnx.png")
...
def main():
    ...
    infer = VFIFormerOnnxInferencer(args.onnx, device=args.device)
