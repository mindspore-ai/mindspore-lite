#!/usr/bin/env python3
"""CogACT policy MindSpore Lite inference (MindIR): image + task -> action chunk."""
...
def _parse_args():
    p = argparse.ArgumentParser(description="CogACT policy MindSpore Lite inference (MindIR)")
