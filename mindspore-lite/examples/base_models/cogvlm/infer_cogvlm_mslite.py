#!/usr/bin/env python3
"""CogVLM skeleton MindSpore Lite inference (MindIR): image + input_ids -> logits."""
...
def _parse_args():
    p = argparse.ArgumentParser(description="CogVLM skeleton MindSpore Lite inference (MindIR)")
