...
# ============================================================================
"""PETR ONNX inference (random-input perf + output shape)."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="PETR ONNX inference")
...
def main():
    ...
    net = PETROnnx(args.model, args.device)
