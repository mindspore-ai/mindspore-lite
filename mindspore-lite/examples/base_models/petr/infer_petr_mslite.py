...
# ============================================================================
"""PETR MindSpore Lite inference (numpy-only, no torch)."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="PETR MindSpore Lite inference")
...
def main():
    ...
    net = PETRMsLite(args.model, args.device, args.device_id)
