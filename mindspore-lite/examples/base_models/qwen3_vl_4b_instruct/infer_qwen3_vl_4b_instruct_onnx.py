...
# ============================================================================
"""
Infer Qwen3-VL-4B-Instruct on ONNX.
"""
...
def _get_vision_position_ids(
    ...
    """
    Get position ids for Qwen3-VL-4B-Instruct.
    """
...
def _parse_args():
    """
    Parse command-line arguments for Qwen3-VL-4B-Instruct ONNX inference.
    """
    parser = argparse.ArgumentParser(
        description="Qwen3-VL-4B-Instruct ONNX inference (vision + prefill + decode)"
    )
    parser.add_argument(
...
def _check_deps():
    """
    Check dependencies for Qwen3-VL-4B-Instruct ONNX inference.
    """
    if ort is None:
        print(
...
def _load_cfg_and_processor(processor_id: str, image_size: int):
    """
    Load Qwen3-VL-4B-Instruct configuration and processor.
    ...
    Returns:
        cfg (AutoConfig): Qwen3-VL-4B-Instruct configuration.
        processor (AutoProcessor): Qwen3-VL-4B-Instruct processor.
    """
...
def _prepare_inputs(processor, image_path: str, prompt: str):
    """
    Prepare inputs for Qwen3-VL-4B-Instruct ONNX inference.
    """
...
def _build_position_ids(
    ...
    """
    Build position ids for Qwen3-VL-4B-Instruct ONNX inference.
...
def _create_sessions(
    ...
    """
    Create ONNX inference sessions for Qwen3-VL-4B-Instruct ONNX inference.
    """
...
def _validate_vision_inputs(vision_sess, pixel_values, image_grid_thw):
    """
    Validate vision inputs for Qwen3-VL-4B-Instruct ONNX inference.
    """
...
def _run_vision(vision_sess, pixel_values):
    """
    Run vision inference for Qwen3-VL-4B-Instruct ONNX inference.
    """
...
def _run_prefill(
    ...
    """
    Run prefill inference for Qwen3-VL-4B-Instruct ONNX inference.
    """
...
def _decode_generate(
    ...
    """
    Decode and generate for Qwen3-VL-4B-Instruct ONNX inference.

    Args:
        decode_sess (ort.InferenceSession): ONNX inference session for Qwen3-VL-4B-Instruct ONNX inference.
...
def main():
    """
    Main function for Qwen3-VL-4B-Instruct ONNX inference.
    """
    args = _parse_args()
    _check_deps()
