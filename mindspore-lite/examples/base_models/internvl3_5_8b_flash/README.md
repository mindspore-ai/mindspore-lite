# InternVL3.5-8B-Flash ONNX 模型导出与 MindSpore Lite 推理部署教程

本教程介绍如何将 [OpenGVLab/InternVL3_5-8B-Flash](https://www.modelscope.cn/models/OpenGVLab/InternVL3_5-8B-Flash) 视觉语言模型按结构拆分导出为 ONNX，转换为 MindSpore Lite MindIR，并在 **Ascend Atlas 300I Duo** 上完成图文推理与精度对齐。
...
```bash
python -c "from modelscope import snapshot_download as s; print(s('OpenGVLab/InternVL3_5-8B-Flash', cache_dir='/home/yf/modelscope_cache'))"
ln -sfn /home/yf/modelscope_cache/OpenGVLab/InternVL3_5-8B-Flash ./InternVL3_5-8B-Flash
```

## 3. 模型导出 ONNX

```bash
cd mindspore-lite/examples/base_models/internvl3_5_8b_flash
python export_internvl3_5_8b_flash_onnx.py \
  --model-id OpenGVLab/InternVL3_5-8B-Flash \
  --output-dir ./internvl3_5_8b_flash_onnx \
...
$CONV --fmk=ONNX --modelFile=./internvl3_5_8b_flash_onnx/internvl_vision.onnx --outputFile=./internvl3_5_8b_flash_onnx/internvl_vision --optimize=ascend_oriented --saveType=MINDIR --configFile=./configs/internvl_vision.config
$CONV --fmk=ONNX --modelFile=./internvl3_5_8b_flash_onnx/internvl_llm_prefill.onnx --outputFile=./internvl3_5_8b_flash_onnx/internvl_llm_prefill --optimize=ascend_oriented --saveType=MINDIR --configFile=./configs/internvl_llm_prefill.config
$CONV --fmk=ONNX --modelFile=./internvl3_5_8b_flash_onnx/internvl_llm_decode.onnx --outputFile=./internvl3_5_8b_flash_onnx/internvl_llm_decode --optimize=ascend_oriented --saveType=MINDIR --configFile=./configs/internvl_llm_decode.config
```
...
```bash
python infer_internvl3_5_8b_flash_mslite.py \
  --mindir-dir ./internvl3_5_8b_flash_onnx --model-dir ./InternVL3_5-8B-Flash \
...
```bash
python align_internvl3_5_8b_flash.py --mindir-dir ./internvl3_5_8b_flash_onnx --model-dir ./InternVL3_5-8B-Flash --image ./test.jpg --max-new-tokens 32
```
...
- 上游：<https://github.com/OpenGVLab/InternVL>、ModelScope `OpenGVLab/InternVL3_5-8B-Flash`
