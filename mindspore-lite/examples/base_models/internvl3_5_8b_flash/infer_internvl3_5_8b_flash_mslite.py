...
# ============================================================================
"""InternVL3.5-8B-Flash vision-language inference with MindSpore Lite (Ascend).
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(description="InternVL3.5-8B-Flash MindSpore Lite inference")
...
def main():
    """Parse arguments and run InternVL3.5-8B-Flash multimodal inference."""
    args = _parse_args()
