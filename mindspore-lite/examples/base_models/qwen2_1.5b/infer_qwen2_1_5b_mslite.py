...
# ============================================================================
"""
Infer Qwen2-1.5B with MindSpore Lite using split MindIR (prefill + decode).
"""
...
class Qwen215BInferencer:
    """Qwen2-1.5B inferencer with MindSpore Lite."""
    ...
    def _prepare_inputs(self, text: str, max_length: int):
        """Prepare inputs for Qwen2-1.5B inference."""
    ...
    def generate(
        ...
        """Generate text using Qwen2-1.5B."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Qwen2-1.5B Inference with MindSpore Lite (prefill + decode)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--tokenizer", type=str, default="./Qwen2-1.5B", help="Tokenizer path"
    )
