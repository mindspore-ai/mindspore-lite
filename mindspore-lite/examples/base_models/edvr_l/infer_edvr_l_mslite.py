...
def _parse_args():
    ...
    p.add_argument("--output", type=str, default="./edvr_l_sr_mslite.png")
...
def main():
    ...
    infer = EdvrLMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
