...
# ============================================================================
"""CenterPoint ONNX inference (random dense BEV perf + output shape)."""
...
class CenterPointOnnx:
    """CenterPoint ONNXRuntime inference."""
...
def main():
    ...
    net = CenterPointOnnx(args.model, args.device)
