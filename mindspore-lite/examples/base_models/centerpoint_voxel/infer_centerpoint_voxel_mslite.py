...
# ============================================================================
"""CenterPoint MindSpore Lite inference (numpy-only, no torch)."""
...
class CenterPointMsLite:
    """CenterPoint MindSpore Lite inference."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="CenterPoint MindSpore Lite inference")
...
def main():
    ...
    net = CenterPointMsLite(args.model, args.device, args.device_id)
    ...
    for name, out in zip(["reg", "height", "dim", "rot", "vel", "heatmap"], outs):
