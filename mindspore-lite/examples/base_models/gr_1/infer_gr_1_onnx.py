#!/usr/bin/env python3
"""GR-1 policy ONNXRuntime inference: video -> action chunk (single forward)."""
...
def _load_video(path, num_frames, img_size):
    """Load a video as [1, T, 3, H, W] float32 (first T frames resized)."""
...
def _parse_args():
    p = argparse.ArgumentParser(description="GR-1 policy ONNXRuntime inference")
    p.add_argument("--model", type=str, required=True)
    p.add_argument("--video-dir", type=str, default="", help="Directory of frames; default seeded random.")
