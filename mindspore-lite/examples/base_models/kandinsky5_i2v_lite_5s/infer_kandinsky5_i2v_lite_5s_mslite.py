...
# ============================================================================
"""End-to-end image-to-video inference for Kandinsky-5.0-I2V-Lite-5s on MindSpore Lite.
...
class Kandinsky5I2IInferencer:
    """End-to-end Kandinsky-5.0-I2V-Lite-5s inferencer over MindSpore Lite."""
    ...
    def _vae_encode_image(self, image):
        ...
        Mirrors ``Kandinsky5I2VPipeline.prepare_latents``: preprocess to
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Kandinsky-5.0-I2V-Lite-5s MindSpore Lite inference")
...
def main():
    """Parse args and run Kandinsky-5.0-I2V-Lite-5s image-to-video inference."""
    args = _parse_args()
