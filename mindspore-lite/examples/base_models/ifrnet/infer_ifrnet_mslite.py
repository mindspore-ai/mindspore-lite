#!/usr/bin/env python3
"""IFRNET MindSpore Lite 推理脚本(MindIR)。
...
class IfrnetMsliteInferencer:
    """IFRNET MindSpore Lite 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="IFRNET MindSpore Lite 推理(MindIR)")
    ...
    p.add_argument("--output", type=str, default="./ifrnet_mid_mslite.png")
...
def main():
    ...
    infer = IfrnetMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
