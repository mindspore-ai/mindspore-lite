#!/usr/bin/env python3
"""IFRNET ONNXRuntime 推理脚本(精度基准 ground truth): 两帧 -> 中点中间帧。"""
...
class IfrnetOnnxInferencer:
    """IFRNET ONNXRuntime 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="IFRNET ONNXRuntime 推理")
    ...
    p.add_argument("--output", type=str, default="./ifrnet_mid_onnx.png")
...
def main():
    ...
    infer = IfrnetOnnxInferencer(args.onnx, device=args.device)
