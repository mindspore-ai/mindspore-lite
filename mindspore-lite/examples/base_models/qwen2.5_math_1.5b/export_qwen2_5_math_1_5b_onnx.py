...
# ============================================================================
"""
Export Qwen2.5-Math-1.5B model to ONNX format.
"""
...
def _text_attn_forward(
    ...
    """
    Text attention forward function for Qwen2.5-Math-1.5B inference.
...
class Qwen2LlmPrefill(torch.nn.Module):
    """Qwen2.5-Math-1.5B LLM Prefill wrapper."""
...
class Qwen2LlmDecode(torch.nn.Module):
    """Qwen2.5-Math-1.5B LLM Decode wrapper."""
...
def _prepare_output_paths(output_dir):
    ...
    prefill_path = prefill_dir / "qwen2_5_math_1_5b_llm_prefill.onnx"
    decode_path = decode_dir / "qwen2_5_math_1_5b_llm_decode.onnx"
...
def main():
    parser = argparse.ArgumentParser(description="Export Qwen2.5-Math-1.5B to ONNX")
    parser.add_argument(
        "--model-id",
        type=str,
        default="./Qwen2.5-Math-1.5B",
        help="HuggingFace model ID or local path",
    )
    parser.add_argument(
        "--output-dir", type=str, default="./qwen2_5_math_1_5b_onnx", help="Output directory"
    )
    parser.add_argument(
