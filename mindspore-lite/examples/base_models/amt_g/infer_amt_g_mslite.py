#!/usr/bin/env python3
"""AMT_G MindSpore Lite 推理脚本(MindIR)。
...
class AmtGMsliteInferencer:
    """AMT_G MindSpore Lite 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="AMT_G MindSpore Lite 推理(MindIR)")
    ...
    p.add_argument("--output", type=str, default="./amt_g_mid_mslite.png")
...
def main():
    ...
    infer = AmtGMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
