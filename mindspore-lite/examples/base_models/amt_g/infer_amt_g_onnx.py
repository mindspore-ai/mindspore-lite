#!/usr/bin/env python3
"""AMT_G ONNXRuntime 推理脚本(精度基准 ground truth): 两帧 -> 中点中间帧。"""
...
class AmtGOnnxInferencer:
    """AMT_G ONNXRuntime 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="AMT_G ONNXRuntime 推理")
    ...
    p.add_argument("--output", type=str, default="./amt_g_mid_onnx.png")
...
def main():
    ...
    infer = AmtGOnnxInferencer(args.onnx, device=args.device)
