...
# ============================================================================
"""SECOND MindSpore Lite inference (numpy-only, no torch)."""
...
class SECONDMsLite:
    """SECOND MindSpore Lite inference."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="SECOND MindSpore Lite inference")
...
def main():
    ...
    net = SECONDMsLite(args.model, args.device, args.device_id)
