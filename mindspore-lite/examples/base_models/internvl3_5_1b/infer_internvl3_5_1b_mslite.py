...
# ============================================================================
"""InternVL3.5-1B vision-language inference with MindSpore Lite (Ascend).
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(description="InternVL3.5-1B MindSpore Lite inference")
...
def main():
    """Parse arguments and run InternVL3.5-1B multimodal inference."""
    args = _parse_args()
