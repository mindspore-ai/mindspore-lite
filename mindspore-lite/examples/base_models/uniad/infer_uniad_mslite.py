...
# ============================================================================
"""UniAD MindSpore Lite inference (numpy-only, no torch)."""
...
class UniADMsLite:
    """UniAD MindSpore Lite inference."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="UniAD MindSpore Lite inference")
...
def main():
    ...
    net = UniADMsLite(args.model, args.device, args.device_id)
