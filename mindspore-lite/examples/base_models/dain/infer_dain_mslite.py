...
def _parse_args():
    ...
    p.add_argument("--output", type=str, default="./dain_mid_mslite.png")
...
def main():
    ...
    infer = DainMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
