...
# ============================================================================
"""End-to-end accuracy alignment for SVD-XT: HF diffusers vs MindSpore Lite.
...
initial latents, scheduler/guidance settings):
  ...
  2. MindSpore Lite pipeline on Ascend (the internals of
     ``infer_svd_img2vid_xt_mslite.SvdInferencer``, driven here so the shared
...
from infer_svd_img2vid_xt_mslite import SvdInferencer
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="SVD-XT HF vs MSLite alignment")
