...
# ============================================================================
"""Export stabilityai/stable-video-diffusion-img2vid-xt to ONNX for MindSpore Lite.

SVD-XT is an image-to-video diffusion model (fixed 1024x576, 25 frames). The
...
(the SVD-XT default, ``unet.config.num_frames``).
"""
...
def _parse_args():
    ...
    parser.add_argument("--resolution", type=int, nargs=2,
                        ...
                        help="Output video frame resolution (fixed for SVD). "
                             "SVD-XT default is 576 1024 (16:9).")
    parser.add_argument("--num-frames", type=int, default=25,
                        help="Number of video frames (SVD-XT default 25).")
...
def main():
    ...
    print(f"SVD-XT ONNX export: resolution={height}x{width}, "
