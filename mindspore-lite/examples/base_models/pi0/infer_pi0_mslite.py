#!/usr/bin/env python3
"""pi0 MindSpore Lite inference (MindIR): image -> action chunk via Flow Matching.
...
def _parse_args():
    p = argparse.ArgumentParser(description="pi0 MindSpore Lite inference (Flow Matching)")
