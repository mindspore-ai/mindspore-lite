...
# ============================================================================
"""VAD ONNX inference (random multi-view perf + output shape)."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="VAD ONNX inference")
...
def main():
    ...
    net = VADOnnx(args.model, args.device)
    ...
    try:
        ...
        print(f"(Custom BEV/deformable op cannot run on ORT: {e})")
        print("Use the MindIR path via infer_vad_mslite.py instead.")
