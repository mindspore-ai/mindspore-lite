#!/usr/bin/env python3
"""OpenVLA-OFT policy MindSpore Lite inference (MindIR): image + task -> action chunk."""
...
def _parse_args():
    p = argparse.ArgumentParser(description="OpenVLA-OFT policy MindSpore Lite inference (MindIR)")
