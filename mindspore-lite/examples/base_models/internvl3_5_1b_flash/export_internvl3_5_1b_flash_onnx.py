...
# ============================================================================
"""Export OpenGVLab/InternVL3_5-1B-Flash to ONNX for MindSpore Lite cloud-side inference.
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(description="Export InternVL3.5-1B-Flash submodules to ONNX")
    parser.add_argument("--model-id", default="./InternVL3_5-1B-Flash")
    parser.add_argument("--output-dir", default="./internvl3_5_1b_flash_onnx")
