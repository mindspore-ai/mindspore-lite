...
# ============================================================================
"""End-to-end image-to-video inference for SV3D on MindSpore Lite (Ascend).
...
class SvdInferencer:
    """SV3D image-to-video on MindSpore Lite (image_encoder / unet+vae)."""
    ...
    def infer(self, image_pil, vae_torch, seed=0, num_inference_steps=25,
        ...
        """Run the full SV3D pipeline. Returns (frames_uint8, timing_dict).
...
def main():
    """Parse arguments and run SV3D image-to-video inference."""
    parser = argparse.ArgumentParser(
        description="SV3D MindSpore Lite inference")
