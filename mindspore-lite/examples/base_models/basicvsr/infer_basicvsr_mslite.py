...
class BasicVsrMsliteInferencer:
...
def _parse_args():
    ...
    p.add_argument("--output", type=str, default="./basicvsr_sr_mslite.png")
...
def main():
    ...
    infer = BasicVsrMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
