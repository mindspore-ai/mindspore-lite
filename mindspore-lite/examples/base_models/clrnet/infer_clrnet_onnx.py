...
# ============================================================================
"""CLRNet ONNX inference (random-input perf + output shape)."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="CLRNet ONNX inference")
...
def main():
    ...
    net = CLRNetOnnx(args.model, args.device)
