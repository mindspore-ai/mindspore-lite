...
# ============================================================================
"""CLRNet MindSpore Lite inference (numpy-only, no torch)."""
...
class CLRNetMsLite:
    """CLRNet MindSpore Lite inference."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="CLRNet MindSpore Lite inference")
...
def main():
    ...
    net = CLRNetMsLite(args.model, args.device, args.device_id)
    ...
    for name, out in zip(["lane_logits", "lane_coords"], outs):
