...
def _parse_args():
    ...
    p.add_argument("--output", type=str, default="./edvr_m_sr_mslite.png")
...
def main():
    ...
    infer = EdvrMMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
