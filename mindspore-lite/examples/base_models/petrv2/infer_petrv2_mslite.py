...
# ============================================================================
"""PETRv2 MindSpore Lite inference (numpy-only, no torch)."""
...
class PETRv2MsLite:
    """PETRv2 MindSpore Lite inference."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="PETRv2 MindSpore Lite inference")
...
def main():
    ...
    net = PETRv2MsLite(args.model, args.device, args.device_id)
