...
# ============================================================================
"""PETRv2 ONNX inference (random-input perf + output shape)."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="PETRv2 ONNX inference")
...
def main():
    ...
    net = PETRv2Onnx(args.model, args.device)
