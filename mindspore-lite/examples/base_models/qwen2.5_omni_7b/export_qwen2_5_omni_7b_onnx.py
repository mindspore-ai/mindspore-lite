...
"""
Export Qwen2.5-Omni-7B Thinker Text LLM to ONNX format.
...
def main():
    parser = argparse.ArgumentParser(
        description="Export Qwen2.5-Omni-7B Thinker Text LLM to ONNX"
    )
    parser.add_argument(
        "--model-id", type=str, default="Qwen/Qwen2.5-Omni-7B",
        help="Model ID or path",
    )
    parser.add_argument(
        "--output-dir", type=str, default="./qwen2_5_omni_7b_onnx",
    ...
    output_path = str(output_dir / "qwen2_5_omni_7b_text.onnx")
