...
# ============================================================================
"""DriveVLM vision encoder ONNX inference (random-input perf + output shape)."""
...
class DriveVLMOnnx:
    """DriveVLM vision encoder ONNXRuntime inference."""
    ...
    def forward(self, pixel_values):
        """run forward."""
        return self.sess.run(self.output_names, {self.input_names[0]: pixel_values})


def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="DriveVLM vision encoder ONNX inference")
...
def main():
    ...
    net = DriveVLMOnnx(args.model, args.device)
