...
# ============================================================================
"""DETR3D MindSpore Lite inference (numpy-only, no torch)."""
...
class DETR3DMsLite:
    """DETR3D MindSpore Lite inference."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="DETR3D MindSpore Lite inference")
...
def main():
    ...
    net = DETR3DMsLite(args.model, args.device, args.device_id)
