...
# ============================================================================
"""DETR3D ONNX inference (random-input perf + output shape)."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="DETR3D ONNX inference")
...
def main():
    ...
    net = DETR3DOnnx(args.model, args.device)
