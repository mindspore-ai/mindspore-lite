#!/usr/bin/env python3
"""AMT_S ONNXRuntime 推理脚本(精度基准 ground truth): 两帧 -> 中点中间帧。"""
...
class AmtSOnnxInferencer:
    """AMT_S ONNXRuntime 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="AMT_S ONNXRuntime 推理")
    ...
    p.add_argument("--output", type=str, default="./amt_s_mid_onnx.png")
...
def main():
    ...
    infer = AmtSOnnxInferencer(args.onnx, device=args.device)
