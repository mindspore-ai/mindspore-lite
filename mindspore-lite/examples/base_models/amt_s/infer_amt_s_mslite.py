#!/usr/bin/env python3
"""AMT_S MindSpore Lite 推理脚本(MindIR)。
...
class AmtSMsliteInferencer:
    """AMT_S MindSpore Lite 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="AMT_S MindSpore Lite 推理(MindIR)")
    ...
    p.add_argument("--output", type=str, default="./amt_s_mid_mslite.png")
...
def main():
    ...
    infer = AmtSMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
