...
# ============================================================================
"""InternVL3.5-8B vision-language inference with MindSpore Lite (Ascend).
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(description="InternVL3.5-8B MindSpore Lite inference")
...
def main():
    """Parse arguments and run InternVL3.5-8B multimodal inference."""
    args = _parse_args()
