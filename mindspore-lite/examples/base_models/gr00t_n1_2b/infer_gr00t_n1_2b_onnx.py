#!/usr/bin/env python3
"""GR00T-N1 ONNXRuntime inference: image -> action chunk via Flow Matching (Euler ODE)."""
...
def euler_sample(step_fn, image, horizon, action_dim, num_steps, rng):
    """Flow Matching Euler integration from t=0 (noise) to t=1 (action)."""
...
def _parse_args():
    p = argparse.ArgumentParser(description="GR00T-N1 ONNXRuntime inference (Flow Matching)")
