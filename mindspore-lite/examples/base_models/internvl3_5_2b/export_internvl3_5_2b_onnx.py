...
# ============================================================================
"""Export OpenGVLab/InternVL3_5-2B to ONNX for MindSpore Lite cloud-side inference.
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(description="Export InternVL3.5-2B submodules to ONNX")
    parser.add_argument("--model-id", default="./InternVL3_5-2B")
    parser.add_argument("--output-dir", default="./internvl3_5_2b_onnx")
