...
# ============================================================================
"""Accuracy alignment for InternVL3.5-2B-Flash: HF reference vs MindSpore Lite.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="InternVL3.5-2B-Flash HF vs MSLite alignment")
    parser.add_argument("--model-dir", required=True)
    parser.add_argument("--image", required=True)
    parser.add_argument("--prompt", default="Describe this image in detail.")
    parser.add_argument("--max-new-tokens", type=int, default=32)
    parser.add_argument("--mindir-dir", default="./internvl3_5_2b_flash_onnx")
