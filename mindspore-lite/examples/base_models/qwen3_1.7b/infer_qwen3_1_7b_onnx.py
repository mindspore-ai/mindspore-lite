...
# ============================================================================
"""
Infer Qwen3-1.7B with ONNX Runtime (prefill + decode).
"""
...
def run_onnx(
    ...
    """
    Run ONNX inference for Qwen3-1.7B.
    """
    ...
    logits, past_kv = prefill_session.run(
        None,
        {
            "input_ids": input_ids,
    ...
    for _ in range(max_new_tokens - 1):
        ...
        logits, past_kv = decode_session.run(
            None,
            {
...
def main():
    """
    Qwen3-1.7B ONNX inference (prefill + decode)
    """
    parser = argparse.ArgumentParser(
        description="Qwen3-1.7B ONNX inference (prefill + decode)"
    )
    parser.add_argument(
