# InternVL3.5-4B ONNX 模型导出与 MindSpore Lite 推理部署教程

本教程介绍如何将 [OpenGVLab/InternVL3_5-4B](https://www.modelscope.cn/models/OpenGVLab/InternVL3_5-4B) 视觉语言模型按结构拆分导出为 ONNX，转换为 MindSpore Lite MindIR，并在 **Ascend Atlas 300I Duo** 上完成图文推理与精度对齐。
...
```bash
python -c "from modelscope import snapshot_download as s; print(s('OpenGVLab/InternVL3_5-4B', cache_dir='/home/yf/modelscope_cache'))"
ln -sfn /home/yf/modelscope_cache/OpenGVLab/InternVL3_5-4B ./InternVL3_5-4B
```
...
```bash
cd mindspore-lite/examples/base_models/internvl3_5_4b
HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 python export_internvl3_5_4b_onnx.py \
  --model-id ./InternVL3_5-4B --output-dir ./internvl3_5_4b_onnx \
...
| 参数 | 说明 | 默认值 |
| --- | --- | --- |
| `--model-id` | 本地权重目录或 ModelScope id | `./InternVL3_5-4B` |
| `--output-dir` | ONNX / embed 输出目录 | `./internvl3_5_4b_onnx` |
...
[export] saved internvl3_5_4b_onnx/internvl_vision.onnx
[export] llm prefill ...
...
[export] embed_weights (151936, 2560) -> internvl3_5_4b_onnx/embed_weights.npy
```
...
$CONV --fmk=ONNX --modelFile=./internvl3_5_4b_onnx/internvl_vision.onnx      --outputFile=./internvl3_5_4b_onnx/internvl_vision      --optimize=ascend_oriented --saveType=MINDIR --configFile=./configs/internvl_vision.config
$CONV --fmk=ONNX --modelFile=./internvl3_5_4b_onnx/internvl_llm_prefill.onnx --outputFile=./internvl3_5_4b_onnx/internvl_llm_prefill --optimize=ascend_oriented --saveType=MINDIR --configFile=./configs/internvl_llm_prefill.config
$CONV --fmk=ONNX --modelFile=./internvl3_5_4b_onnx/internvl_llm_decode.onnx  --outputFile=./internvl3_5_4b_onnx/internvl_llm_decode  --optimize=ascend_oriented --saveType=MINDIR --configFile=./configs/internvl_llm_decode.config
```
...
```bash
HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 python infer_internvl3_5_4b_mslite.py \
  --mindir-dir ./internvl3_5_4b_onnx --model-dir ./InternVL3_5-4B \
...
--- Performance ---
  Vision encode:   96.63 ms
  LLM prefill:     626.29 ms (seq=320)
  LLM decode:      24002.76 ms (94 steps)
  End-to-end:      24725.69 ms
  Avg decode step: 303.83 ms
  Throughput:      3.29 tok/s (decode)
```
...
| **端到端（128 tok 上限）** | **~24.7 s** |
| **decode 吞吐** | **3.29 tok/s** |
...
HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1 python align_internvl3_5_4b.py \
  --model-dir ./InternVL3_5-4B --image ./test.jpg --dump-dir ./align_dump --max-new-tokens 32
# 推理环境（mindspore-lite）：MSLite prefill 首 token 余弦对齐
python align_internvl3_5_4b.py --mindir-dir ./internvl3_5_4b_onnx --dump-dir ./align_dump --check-mslite
```
...
- 上游：<https://github.com/OpenGVLab/InternVL>、ModelScope `OpenGVLab/InternVL3_5-4B`
