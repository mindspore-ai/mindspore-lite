...
# ============================================================================
"""Export OpenGVLab/InternVL3_5-4B to ONNX for MindSpore Lite cloud-side inference.
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(description="Export InternVL3.5-4B submodules to ONNX")
    parser.add_argument("--model-id", default="./InternVL3_5-4B")
    parser.add_argument("--output-dir", default="./internvl3_5_4b_onnx")
