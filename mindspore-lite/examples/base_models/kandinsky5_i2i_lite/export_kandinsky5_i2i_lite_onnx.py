...
# ============================================================================
"""Export kandinskylab/Kandinsky-5.0-I2I-Lite to ONNX for MindSpore Lite Ascend.

Kandinsky-5.0-I2I-Lite is the image-to-image variant of the ~6B flow-matching
DiT. Its upstream layout (verified against the kandinsky-5 repo + diffusers
``Kandinsky5I2IPipeline``) is identical to the T2I Lite sibling except for the
...
def export_transformer(model_path, output_dir, height, width, max_seq_len,
    ...
    # K5 I2I ships as a diffusers dir (Kandinsky-5.0-I2I-Lite-sft-Diffusers) OR
...
def _parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Export Kandinsky-5.0-I2I-Lite submodules to ONNX")
    parser.add_argument(
        "--k5-model", required=True,
        help="Path to the K5 I2I Lite checkpoint: a diffusers dir "
             "(Kandinsky-5.0-I2I-Lite-sft-Diffusers/transformer) OR a "
    ...
    parser.add_argument(
        "--output-dir", default="./kandinsky5_i2i_lite_onnx",
