#!/usr/bin/env python3
"""LLaVA-1.5 skeleton MindSpore Lite inference (MindIR): image + input_ids -> logits."""
...
def _parse_args():
    p = argparse.ArgumentParser(description="LLaVA-1.5 skeleton MindSpore Lite inference (MindIR)")
