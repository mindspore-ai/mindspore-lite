#!/usr/bin/env python3
"""RIFE MindSpore Lite 推理脚本(MindIR)。
...
class RifeMsliteInferencer:
    """RIFE MindSpore Lite 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="RIFE MindSpore Lite 推理(MindIR)")
    ...
    p.add_argument("--output", type=str, default="./rife_mid_mslite.png")
...
def main():
    ...
    infer = RifeMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
