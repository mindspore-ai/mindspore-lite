...
def _parse_args():
    ...
    p.add_argument("--output", type=str, default="./vrt_sr_mslite.png")
...
def main():
    ...
    infer = VrtMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
