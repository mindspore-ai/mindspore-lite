#!/usr/bin/env python3
"""BMBC MindSpore Lite 推理脚本(MindIR)。
...
class BmbcMsliteInferencer:
    """BMBC MindSpore Lite 推理封装。"""
...
def _parse_args():
    p = argparse.ArgumentParser(description="BMBC MindSpore Lite 推理(MindIR)")
    ...
    p.add_argument("--output", type=str, default="./bmbc_mid_mslite.png")
...
def main():
    ...
    infer = BmbcMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
