...
"""
Export Qwen3-Embedding-8B model to ONNX format.
...
class Qwen3EmbeddingWrapper(torch.nn.Module):
    """
    Wrapper for Qwen3-Embedding-8B that outputs pooled embeddings.
...
def _parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="Export Qwen3-Embedding-8B to ONNX")
    parser.add_argument(
        "--model-id",
        type=str,
...
def main():
    ...
    output_path = os.path.join(args.output_dir, "qwen3_embedding_8b.onnx")
