...
"""
Export Qwen2-Audio-7B Language Model to ONNX format.

This script extracts the text LLM backbone from Qwen2-Audio-7B
...
def main():
    parser = argparse.ArgumentParser(
        description="Export Qwen2-Audio-7B Text LLM to ONNX"
    )
    parser.add_argument(
        "--model-id", type=str, default="Qwen/Qwen2-Audio-7B",
        help="Model ID or local path",
    )
    parser.add_argument(
        "--output-dir", type=str, default="./qwen2_audio_7b_onnx",
    ...
    print(f"Loading Qwen2-Audio-7B model from {args.model_id}...")
    ...
    output_path = str(output_dir / "qwen2_audio_7b_text.onnx")
