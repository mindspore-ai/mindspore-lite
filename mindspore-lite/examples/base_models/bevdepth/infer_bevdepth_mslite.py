...
# ============================================================================
"""BEVDepth MindSpore Lite inference (numpy-only, no torch)."""
...
class BEVDepthMsLite:
    """BEVDepth MindSpore Lite inference."""
...
def parse_args():
    """parse args"""
    parser = argparse.ArgumentParser(description="BEVDepth MindSpore Lite inference")
...
def main():
    ...
    net = BEVDepthMsLite(args.model, args.device, args.device_id)
