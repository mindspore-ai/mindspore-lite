#!/usr/bin/env python3
"""OpenVLA policy MindSpore Lite inference (MindIR): image + task -> action chunk.
...
def _parse_args():
    p = argparse.ArgumentParser(description="OpenVLA policy MindSpore Lite inference (MindIR)")
