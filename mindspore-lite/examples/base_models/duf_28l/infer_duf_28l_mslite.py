...
def _parse_args():
    ...
    p.add_argument("--output", type=str, default="./duf_28l_sr_mslite.png")
...
def main():
    ...
    infer = Duf28lMsliteInferencer(args.mindir, device=args.device, device_id=args.device_id)
