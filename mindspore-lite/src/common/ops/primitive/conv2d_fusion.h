...
#ifndef LITE_CONVERTER_TOOLS_OPS_CONV2D_FUSION_H_
#define LITE_CONVERTER_TOOLS_OPS_CONV2D_FUSION_H_
#include <vector>
...
class OPS_API Conv2DFusion : public Conv2D {
 public:
...
#endif  // LITE_CONVERTER_TOOLS_OPS_CONV2D_FUSION_H_
