...
#ifndef LITE_CONVERTER_TOOLS_OPS_FUSION_MAT_MUL_FUSION_H_
#define LITE_CONVERTER_TOOLS_OPS_FUSION_MAT_MUL_FUSION_H_
#include <memory>
...
#endif  // LITE_CONVERTER_TOOLS_OPS_FUSION_MAT_MUL_FUSION_H_
