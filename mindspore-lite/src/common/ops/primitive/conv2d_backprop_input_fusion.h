...
#ifndef LITE_CONVERTER_TOOLS_OPS_CONV2D_BACKPROP_INPUT_FUSION_H_
#define LITE_CONVERTER_TOOLS_OPS_CONV2D_BACKPROP_INPUT_FUSION_H_
#include <vector>
...
class OPS_API Conv2DBackpropInputFusion : public Conv2DBackpropInput {
 public:
...
#endif  // LITE_CONVERTER_TOOLS_OPS_CONV2D_BACKPROP_INPUT_FUSION_H_
