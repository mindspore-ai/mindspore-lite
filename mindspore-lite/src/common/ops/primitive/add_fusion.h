...
#ifndef LITE_CONVERTER_TOOLS_OPS_ADD_FUSION_H_
#define LITE_CONVERTER_TOOLS_OPS_ADD_FUSION_H_
#include <memory>
#include <vector>
...
class OPS_API AddFusion : public BaseOperator {
 public:
...
#endif  // LITE_CONVERTER_TOOLS_OPS_ADD_FUSION_H_
