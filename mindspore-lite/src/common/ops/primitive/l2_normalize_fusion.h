...
#ifndef LITE_CONVERTER_TOOLS_OPS_L2_NORMALIZE_FUSION_H_
#define LITE_CONVERTER_TOOLS_OPS_L2_NORMALIZE_FUSION_H_
#include <vector>
...
#endif  // LITE_CONVERTER_TOOLS_OPS_L2_NORMALIZE_FUSION_H_
