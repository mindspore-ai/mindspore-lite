...
#ifndef LITE_CONVERTER_TOOLS_OPS_CONV2D_TRANSPOSE_FUSION_H_
#define LITE_CONVERTER_TOOLS_OPS_CONV2D_TRANSPOSE_FUSION_H_
#include <vector>
...
#endif  // LITE_CONVERTER_TOOLS_OPS_CONV2D_TRANSPOSE_FUSION_H_
