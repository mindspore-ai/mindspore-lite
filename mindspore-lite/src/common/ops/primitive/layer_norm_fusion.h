...
#ifndef LITE_CONVERTER_TOOLS_OPS_LAYER_NORM_FUSION_H_
#define LITE_CONVERTER_TOOLS_OPS_LAYER_NORM_FUSION_H_
#include <memory>
#include <vector>
...
#endif  // LITE_CONVERTER_TOOLS_OPS_LAYER_NORM_FUSION_H_
