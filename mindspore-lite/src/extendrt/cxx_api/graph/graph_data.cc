...
namespace mindspore {
Graph::GraphData::GraphData(const FuncGraphPtr &func_graph, mindspore::ModelType model_type)
...
Graph::GraphData::GraphData(const Buffer &om_data, mindspore::ModelType model_type)
