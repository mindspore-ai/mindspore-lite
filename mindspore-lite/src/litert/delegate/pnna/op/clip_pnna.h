 ...
 */
#ifndef MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_CLIP_PNNA_H_
#define MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_CLIP_PNNA_H_
...
namespace mindspore {
namespace lite {
class PNNAClip : public PNNAOp {
 public:
  PNNAClip(const std::string &name, const schema::Primitive *primitive,
...
#endif  // MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_CLIP_PNNA_H_
