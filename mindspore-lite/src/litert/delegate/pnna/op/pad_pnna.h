 ...
 */
#ifndef MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_PAD_PNNA_H_
#define MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_PAD_PNNA_H_

#include "src/litert/delegate/pnna/op/pnna_op.h"

namespace mindspore {
namespace lite {
class PNNAPad : public PNNAOp {
 public:
  PNNAPad(const std::string &name, const schema::Primitive *primitive,
 ...
 private:
  ...
  int32_t const_val_;
  pnna::ops::Pad::pad_mode_type pad_mode_;
};
}  // namespace lite
}  // namespace mindspore
#endif  // MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_PAD_PNNA_H_
