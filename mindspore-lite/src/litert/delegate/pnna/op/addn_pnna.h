 ...
 */
#ifndef MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_ADDN_PNNA_H_
#define MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_ADDN_PNNA_H_
...
namespace mindspore {
namespace lite {
class PNNAAddN : public PNNAOp {
 public:
  PNNAAddN(const std::string &name, const schema::Primitive *primitive,
...
#endif  // MINDSPORE_LITE_SRC_LITERT_DELEGATE_PNNA_OP_ADDN_PNNA_H_
