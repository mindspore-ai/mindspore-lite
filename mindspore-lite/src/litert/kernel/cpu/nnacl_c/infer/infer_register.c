...
#ifdef _MSC_VER
#include "nnacl_c/infer/activation_grad_infer.h"
#include "nnacl_c/infer/adam_infer.h"
#include "nnacl_c/infer/adam_weight_decay_infer.h"
#include "nnacl_c/infer/add_sub_grad_infer.h"
#include "nnacl_c/infer/addn_infer.h"
#include "nnacl_c/infer/affine_infer.h"
#include "nnacl_c/infer/all_gather_infer.h"
#include "nnacl_c/infer/apply_momentum_infer.h"
#include "nnacl_c/infer/argmin_max_infer.h"
#include "nnacl_c/infer/arithmetic_compare_infer.h"
#include "nnacl_c/infer/arithmetic_grad_infer.h"
#include "nnacl_c/infer/arithmetic_infer.h"
#include "nnacl_c/infer/assert_op_infer.h"
#include "nnacl_c/infer/assign_add_infer.h"
#include "nnacl_c/infer/assign_infer.h"
#include "nnacl_c/infer/attention_infer.h"
#include "nnacl_c/infer/encoder_layer_infer.h"
#include "nnacl_c/infer/audio_spectrogram_infer.h"
#include "nnacl_c/infer/batch_to_space_infer.h"
#include "nnacl_c/infer/bias_grad_infer.h"
#include "nnacl_c/infer/binary_cross_entropy_infer.h"
#include "nnacl_c/infer/bn_grad_infer.h"
#include "nnacl_c/infer/broadcast_to_infer.h"
#include "nnacl_c/infer/cast_infer.h"
#include "nnacl_c/infer/common_infer.h"
#include "nnacl_c/infer/concat_infer.h"
#include "nnacl_c/infer/constant_of_shape_infer.h"
#include "nnacl_c/infer/decoder_layer_infer.h"

#ifdef MSLITE_ENABLE_CONTROLFLOW
#include "nnacl_c/infer/control/tensor_array_infer.h"
#include "nnacl_c/infer/control/tensor_array_read_infer.h"
#include "nnacl_c/infer/control/tensor_array_write_infer.h"
#include "nnacl_c/infer/control/tensorlist_fromtensor_infer.h"
...
#include "nnacl_c/infer/control/tensorlist_stack_infer.h"
#endif
#include "nnacl_c/infer/conv2d_grad_filter_infer.h"
#include "nnacl_c/infer/conv2d_grad_input_infer.h"
#include "nnacl_c/infer/conv2d_infer.h"
#include "nnacl_c/infer/crop_and_resize_infer.h"
#include "nnacl_c/infer/crop_infer.h"
#include "nnacl_c/infer/cumsum_infer.h"
#include "nnacl_c/infer/deconv2d_infer.h"
#include "nnacl_c/infer/depth_to_space_infer.h"
#include "nnacl_c/infer/depthwise_conv2d_infer.h"
#include "nnacl_c/infer/detection_post_process_infer.h"
#include "nnacl_c/infer/dropout_grad_infer.h"
#include "nnacl_c/infer/dropout_infer.h"
#include "nnacl_c/infer/dynamic_quant_infer.h"
#include "nnacl_c/infer/embedding_lookup_infer.h"
#include "nnacl_c/infer/expand_dims_infer.h"
#include "nnacl_c/infer/fft_imag_infer.h"
#include "nnacl_c/infer/fft_real_infer.h"
#include "nnacl_c/infer/fill_infer.h"
#include "nnacl_c/infer/fillv2_infer.h"
#include "nnacl_c/infer/flatten_grad_infer.h"
#include "nnacl_c/infer/flatten_infer.h"
#include "nnacl_c/infer/full_connection_infer.h"
#include "nnacl_c/infer/fused_batchnorm_infer.h"
#include "nnacl_c/infer/gather_infer.h"
#include "nnacl_c/infer/gather_nd_infer.h"
#include "nnacl_c/infer/glu_infer.h"
#include "nnacl_c/infer/group_conv2d_grad_input_infer.h"
#include "nnacl_c/infer/gru_infer.h"
#include "nnacl_c/infer/instance_norm_infer.h"
#include "nnacl_c/infer/invert_permutation_infer.h"
#include "nnacl_c/infer/layer_norm_grad_infer.h"
#include "nnacl_c/infer/layer_norm_infer.h"
#include "nnacl_c/infer/lin_space_infer.h"
#include "nnacl_c/infer/log_softmax_infer.h"
#include "nnacl_c/infer/lstm_grad_data_infer.h"
#include "nnacl_c/infer/lstm_grad_infer.h"
#include "nnacl_c/infer/lstm_grad_weight_infer.h"
#include "nnacl_c/infer/lstm_infer.h"
#include "nnacl_c/infer/matmul_infer.h"
#include "nnacl_c/infer/max_min_grad_infer.h"
#include "nnacl_c/infer/mfcc_infer.h"
#include "nnacl_c/infer/nllloss_grad_infer.h"
#include "nnacl_c/infer/nllloss_infer.h"
#include "nnacl_c/infer/non_max_suppression_infer.h"
#include "nnacl_c/infer/one_hot_infer.h"
#include "nnacl_c/infer/pad_infer.h"
#include "nnacl_c/infer/pooling_grad_infer.h"
#include "nnacl_c/infer/pooling_infer.h"
#include "nnacl_c/infer/power_infer.h"
#include "nnacl_c/infer/prior_box_infer.h"
#include "nnacl_c/infer/quant_dtype_cast_infer.h"
#include "nnacl_c/infer/ragged_range_infer.h"
#include "nnacl_c/infer/random_normal_infer.h"
#include "nnacl_c/infer/random_standard_normal_infer.h"
#include "nnacl_c/infer/range_infer.h"
#include "nnacl_c/infer/rank_infer.h"
#include "nnacl_c/infer/reduce_infer.h"
#include "nnacl_c/infer/reduce_scatter_infer.h"
#include "nnacl_c/infer/reshape_infer.h"
#include "nnacl_c/infer/resize_grad_infer.h"
#include "nnacl_c/infer/resize_infer.h"
#include "nnacl_c/infer/rfft_infer.h"
#include "nnacl_c/infer/roi_pooling_infer.h"
#include "nnacl_c/infer/scatter_nd_infer.h"
#include "nnacl_c/infer/scatter_nd_update_infer.h"
#include "nnacl_c/infer/select_infer.h"
#include "nnacl_c/infer/sgd_infer.h"
#include "nnacl_c/infer/invalid_infer.h"
#ifndef RUNTIME_PASS_CLIP
#include "nnacl_c/infer/shape_fusion_infer.h"
#endif
#include "nnacl_c/infer/shape_infer.h"
#include "nnacl_c/infer/size_infer.h"
#include "nnacl_c/infer/slice_infer.h"
#include "nnacl_c/infer/softmax_cross_entropy_infer.h"
#include "nnacl_c/infer/softmax_infer.h"
#include "nnacl_c/infer/space_to_batch_infer.h"
#include "nnacl_c/infer/space_to_batch_nd_infer.h"
#include "nnacl_c/infer/space_to_depth_infer.h"
#include "nnacl_c/infer/sparse_softmax_cross_entropy_with_logits_infer.h"
#include "nnacl_c/infer/sparse_to_dense_infer.h"
#include "nnacl_c/infer/splice_infer.h"
#include "nnacl_c/infer/split_infer.h"
#include "nnacl_c/infer/split_with_over_lap_infer.h"
#include "nnacl_c/infer/squeeze_infer.h"
#include "nnacl_c/infer/stack_infer.h"
#include "nnacl_c/infer/strided_slice_grad_infer.h"
#include "nnacl_c/infer/strided_slice_infer.h"
#ifdef MSLITE_ENABLE_STRING_KERNEL
#include "nnacl_c/infer/string/custom_extract_features_infer.h"
#include "nnacl_c/infer/string/custom_normalize_infer.h"
#include "nnacl_c/infer/string/custom_predict_infer.h"
#include "nnacl_c/infer/string/hashtable_lookup_infer.h"
#include "nnacl_c/infer/string/lsh_projection_infer.h"
#include "nnacl_c/infer/string/skip_gram_infer.h"
#endif
#include "nnacl_c/infer/tile_infer.h"
#include "nnacl_c/infer/topk_infer.h"
#include "nnacl_c/infer/transpose_infer.h"
#include "nnacl_c/infer/uniform_real_infer.h"
#include "nnacl_c/infer/unique_infer.h"
#include "nnacl_c/infer/unsorted_segment_sum_infer.h"
#include "nnacl_c/infer/unsqueeze_infer.h"
#include "nnacl_c/infer/unstack_infer.h"
#include "nnacl_c/infer/where_infer.h"
#include "nnacl_c/infer/isfinite_infer.h"
#include "nnacl_c/infer/fse_decoder_infer.h"
#include "nnacl_c/infer/custom_gru_infer.h"
