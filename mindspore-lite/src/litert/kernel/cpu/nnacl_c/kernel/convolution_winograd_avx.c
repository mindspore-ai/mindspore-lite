...
void ConvWinoAVXInitGlobalVariable(ConvolutionBaseStruct *conv) {
  ConvolutionWinogradBaseStruct *winograd = (ConvolutionWinogradBaseStruct *)conv;
  winograd->oc_block_ = C16NUM;
  winograd->tmp_data_tile_ = C8NUM;
...
ConvolutionWinogradBaseStruct *CreateConvWinogradAVX(ConvParameter *conv_param) {
  ...
  winograd->conv_.init_global_variable_ = ConvWinoAVXInitGlobalVariable;
