...
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_DSP_FT04_APPLYMOMENTUM_H_
...
class ApplyMomentumDSPKernel : public DSPKernel {
 public:
  ...
  ~ApplyMomentumDSPKernel() override = default;
 ...
 private:
  int ApplyMomentumRunFp32();
  int ApplyMomentumRunFp16();
