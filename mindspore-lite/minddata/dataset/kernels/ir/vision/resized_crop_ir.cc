...
#include "mindspore-lite/minddata/dataset/kernels/image/resized_crop_op.h"
#endif
#if !defined(BUILD_LITE) && defined(ENABLE_D)
#include "mindspore-lite/minddata/dataset/kernels/image/dvpp/ascend910b/dvpp_resized_crop_op.h"
#endif
