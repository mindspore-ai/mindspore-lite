...
#include "mindspore-lite/minddata/dataset/engine/gpu_item_connector.h"
...
#ifdef WITH_BACKEND
#include "mindspore/ccsrc/include/runtime/hardware_abstract/data_queue/data_queue_mgr.h"
