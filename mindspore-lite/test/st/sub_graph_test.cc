...
TEST_F(SubGraphTest, RecursiveSubGraphTest) {
  ...
  lite::MetaGraphSerializer::Save(
    *meta_graph, "/mnt/data/workspace/OpenAI/Huawei/mindspore-lite/my_test/models/recursive_subgraph");
  //  -----------------------------------------------------------------------
  size_t size = 0;
  char *graph_buf = lite::ReadFile(
    "/mnt/data/workspace/OpenAI/Huawei/mindspore-lite/my_test/models/recursive_subgraph.ms", &size);
