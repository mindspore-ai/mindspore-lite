...
class SpaceToBatchNdInferTest : public mindspore::CommonTest {
 public:
  SpaceToBatchNdInferTest() {}
};

// https://tensorflow.google.cn/api_docs/python/tf/space_to_batch_nd?hl=en
TEST_F(SpaceToBatchNdInferTest, SpaceToBatchNdInferTest0) {
  ...
  int ret = SpaceToBatchNdInferShape((const TensorC **)inputs.data(), inputs.size(), outputs.data(), outputs.size(),
