...
class EmbeddingLookupInferTest : public mindspore::CommonTest {
 public:
  EmbeddingLookupInferTest() {}
};

// https://tensorflow.google.cn/api_docs/python/tf/nn/embedding_lookup?hl=en
