...
function Run_Build_x86() {
  ...
  cd ${open_source_lite_path}/output/ || exit 1
  ...
  # cp tools folder
  cd ${open_source_lite_path}/output/mindspore-lite-${version}-linux-x64 || exit 1
  ...
  if [ $? = 0 ]; then
    ...
    hi3516d_release_path=${open_source_lite_path}/output/mindspore-lite-${version}-linux-x64/tools/converter/providers/Hi3516D
    ...
    hi3559a_release_path=${open_source_lite_path}/output/mindspore-lite-${version}-linux-x64/tools/converter/providers/Hi3559A
    ...
    rm ${open_source_lite_path}/output/mindspore-lite-${version}-linux-x64.tar.gz
...
#set -e
open_source_lite_path=${basepath}/mindspore-lite
