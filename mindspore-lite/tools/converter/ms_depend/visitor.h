...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_VISITOR_H
#define MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_VISITOR_H
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_VISITOR_H
