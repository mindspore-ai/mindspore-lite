...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_PATTERN_ENGINE_H
#define MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_PATTERN_ENGINE_H
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_PATTERN_ENGINE_H
