 ...
 */
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_GRAPH_OPTIMIZER_H
#define MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_GRAPH_OPTIMIZER_H
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_MS_DEPEND_GRAPH_OPTIMIZER_H
