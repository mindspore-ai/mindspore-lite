...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_PARSER_ONNX_ONNX_TFIDFVECTORIZER_PARSER_H_
...
namespace mindspore {
namespace lite {
class OnnxTfIdfVectorizerParser : public OnnxNodeParser {
 public:
  OnnxTfIdfVectorizerParser() : OnnxNodeParser("TfIdfVectorizer") {}
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_PARSER_ONNX_ONNX_TFIDFVECTORIZER_PARSER_H_
