...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_PARSER_ONNX_ONNX_MULTI_SCALE_DEFORMABLE_ATTN_FUNCTION_PARSER_H_
...
namespace mindspore {
namespace lite {
class OnnxMultiScaleDeformableAttnFunctionParser : public OnnxNodeParser {
 public:
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_PARSER_ONNX_ONNX_MULTI_SCALE_DEFORMABLE_ATTN_FUNCTION_PARSER_H_
