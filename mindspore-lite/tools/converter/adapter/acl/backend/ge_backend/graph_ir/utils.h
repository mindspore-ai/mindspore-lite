/**
 * copy from https://gitcode.com/mindspore/mindspore/blob/master/mindspore/ccsrc/backend/ge_backend/graph_ir/utils.h
 *
...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_ACL_BACKEND_GE_BACKEND_GRAPH_IR_UTILS_H_
#define MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_ACL_BACKEND_GE_BACKEND_GRAPH_IR_UTILS_H_
#include <string>
#include <map>
#include <memory>
#include <vector>
#include "tools/converter/adapter/acl/backend/ge_backend/graph_ir/convert.h"
#include "tools/converter/adapter/acl/backend/ge_backend/graph_ir/graph_runner.h"
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_ACL_BACKEND_GE_BACKEND_GRAPH_IR_UTILS_H_
