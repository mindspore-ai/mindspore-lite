...
#ifndef MINDSPORE_LITE_TOOLS_OPTIMIZER_FUSION_CAST_FUSION_H_
#define MINDSPORE_LITE_TOOLS_OPTIMIZER_FUSION_CAST_FUSION_H_
...
namespace mindspore {
namespace opt {
class CastFusionPass : public MultiplePatternProcessPass {
 public:
  explicit CastFusionPass(const std::string &name = "CastFusion", bool multigraph = true)
      : MultiplePatternProcessPass(name, multigraph) {}

  ~CastFusionPass() override = default;
