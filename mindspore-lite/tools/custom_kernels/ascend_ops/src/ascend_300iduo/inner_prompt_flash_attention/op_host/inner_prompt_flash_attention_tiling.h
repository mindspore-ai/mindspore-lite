...
#include "data_copy_transpose_tiling_def.h"  // NOLINT(build/include_subdir)
...
#include "inner_prompt_flash_attention_tiling_compile_info.h"  // NOLINT(build/include_subdir)
#include "inner_prompt_flash_attention_tiling_const.h"         // NOLINT(build/include_subdir)
#include "inner_prompt_flash_attention_tiling_context.h"       // NOLINT(build/include_subdir)
#include "inner_prompt_flash_attention_tiling_struct.h"        // NOLINT(build/include_subdir)
#include "fia_tiling_templates_registry.h"                     // NOLINT(build/include_subdir)
...
BEGIN_TILING_DATA_DEF(InnerPromptFlashAttentionTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention, InnerPromptFlashAttentionTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000000000000, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000000000001, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000000000002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000000000003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000000100002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000000100003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000010000002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000010000003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000010100002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000010100003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000020000002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000020000003, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000020100002, MLAGeneralTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_4000000000020100003, MLAGeneralTilingData)

BEGIN_TILING_DATA_DEF(InnerPromptFlashAttentionBaseApiTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_1000000000000112288, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_1000000000000122288, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_2000000002004000012, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_2000000000004001012, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_2000000010004001012, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_2000000000004000012, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_2000000010004000012, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_2000000002004010112, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_2000000000004010112, InnerPromptFlashAttentionBaseApiTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_2000000010004010112, InnerPromptFlashAttentionBaseApiTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_1000000000000000090, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_10000000000000090, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_1002312000040001212, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_1002312000040021212, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_1001311000000001212, FlashAttentionScoreSimplifiedTilingData)
REGISTER_TILING_DATA_CLASS(InnerPromptFlashAttention_1001311000000021212, FlashAttentionScoreSimplifiedTilingData)
...
class InnerPromptFlashAttentionTiling : public FiaTilingBase {
 public:
  explicit InnerPromptFlashAttentionTiling(gert::TilingContext *context)
      : FiaTilingBase(context), ascendcPlatform(nullptr) {}
  ~InnerPromptFlashAttentionTiling() override = default;
  ge::graphStatus RunBigKernelTilingWithParams(ContextParamsForInnerPFA &contextKeyParams, uint64_t &tilingKey,
                                               uint32_t &numBlocksToBeSet,
                                               InnerPromptFlashAttentionTilingData &tilingData);
  ge::graphStatus InnerPromptFlashAttentionSetTilingData(gert::TilingContext *context,
                                                         InnerPromptFlashAttentionTilingData &tilingData);
  bool CheckNonEmptyShapeExceptions(ContextParamsForInnerPFA &contextKeyParams, const gert::StorageShape *shape,
                                    const std::string &sName);
  bool fromPFA_ = true;
  bool CheckBaseApiNonEmptyShapeExceptions(ContextParamsForInnerPFA &contextKeyParams, const gert::StorageShape *shape,
                                           const std::string &sName);
 ...
 protected:
  ...
  ge::graphStatus TilingGetTilingKeyAttentionAscendC(uint64_t &tilingKey,
                                                     ...
                                                     bool useNewTiling,
                                                     InnerPromptFlashAttentionTilingData &tilingData);
  void InnerPromptFlashAttentionSplitNS(const ContextParamsForInnerPFA &contextKeyParams,
                                        InnerPromptFlashAttentionTilingData &tilingData, uint32_t curCoreNum,
                                        const std::vector<int64_t> &actualSeqLengths);
  void InnerPromptFlashAttentionSplitNSNew(const ContextParamsForInnerPFA &contextKeyParams,
                                           InnerPromptFlashAttentionTilingData &tilingData, uint32_t curCoreNum,
                                           const std::vector<int64_t> &actualSeqLengths,
                                           const std::vector<int64_t> &actualSeqLengthsKV,
                                           int64_t actualSharedPrefixLen, bool useBalanceTiling);
  void GetPreNextTokensLeftUp(InnerPromptFlashAttentionTilingData &tilingData, uint32_t actualSeqLength,
                              uint32_t actualSeqLengthKV, int64_t &preTokensLeftUp, int64_t &nextTokensLeftUp);
  void SetSplitCoreMode(InnerPromptFlashAttentionTilingData &tilingData, uint32_t sOuterFactor);
  void InnerPromptFlashAttentionSplitSeqOneN(InnerPromptFlashAttentionTilingData &tilingData, uint32_t curCoreNum,
                                             bool isVectorCore);
  bool EnableMTE2BmmPipe(InnerPromptFlashAttentionTilingData &tilingData, matmul_tiling::MatmulApiTiling &bmm,
  ...
  void InnerPromptFlashAttention310PSetBmm1(matmul_tiling::MatmulApiTiling &bmm1);
  void InnerPromptFlashAttention310PSetBmm2(matmul_tiling::MatmulApiTiling &bmm2);
  bool InnerPromptFlashAttentionCheckBmm1(InnerPromptFlashAttentionTilingData &tilingData, TCubeTiling &bmm1TilingData,
                                          int64_t l1SizeRemain, int64_t l0CSize, uint32_t sOuterFactor,
                                          uint32_t sInnerFactor, bool allGM = false, bool autoBaseMNK = false);
  bool InnerPromptFlashAttentionCheckBmm2(InnerPromptFlashAttentionTilingData &tilingData, TCubeTiling &bmm1TilingData,
                                          int64_t l1SizeRemain, int64_t l0CSize, uint32_t sOuterFactor,
                                          uint32_t sInnerFactor, uint32_t dSplitFactor, bool allGM = false,
                                          bool autoBaseMNK = false);
  void InnerPromptFlashAttentionSetTensorSize(InnerPromptFlashAttentionTilingData &tilingData,
                                              PromptAttentionSingleCoreTensorSize &tensorSize, uint32_t sOuterFactor,
                                              uint32_t sInnerFactor);
  bool InnerPromptFlashAttentionCheckArgsLegal(InnerPromptFlashAttentionTilingData &tilingData, int64_t ubSize,
  ...
  ge::graphStatus AdjustBasicBlock(InnerPromptFlashAttentionTilingData &tilingData, uint32_t &sOuterFactor);
  ge::graphStatus InnerPromptFlashAttentionApiTiling(InnerPromptFlashAttentionTilingData &tilingData, uint32_t typeSize,
  ...
  void InnerPromptFlashAttentionInitOutputSplit(uint64_t totalSize, InnerPromptFlashAttentionTilingData &tilingData,
                                                uint32_t curCoreNum);
  void InnerPromptFlashAttentionInitSoftmaxLseOutputSplit(uint64_t totalSize,
                                                          InnerPromptFlashAttentionTilingData &tilingData);
  ...
  ge::graphStatus GetBasicShape910B(uint32_t &b, uint32_t &s, uint32_t &h, uint32_t &seqInnerSize,
                                    const gert::StorageShape *queryShape, const gert::StorageShape *keyShape,
                                    const uint32_t n);
  size_t GetPFAWorkSpaceSize(InnerPromptFlashAttentionTilingData &tilingData);
  void GetMatMulType(matmul_tiling::DataType &mmInputType, matmul_tiling::DataType &mmOutputType);
  ge::graphStatus CheckKeyValueParamsConsistency(const ContextParamsForInnerPFA &contextKeyParams);
  bool CheckActualSeqLength(ContextParamsForInnerPFA &contextKeyParams, uint32_t b, uint32_t sQ, uint32_t sKV,
                            const gert::Tensor *actualSeqLenQ, const gert::Tensor *actualSeqLenKV, InputLayout inLayout,
                            InnerPromptFlashAttentionTilingData &tilingData);
  bool CheckPseShiftTypeAndShape(const ContextParamsForInnerPFA &contextKeyParams,
                                 const gert::StorageShape *pseShiftShape, uint32_t b, uint64_t n, uint32_t s1,
                                 uint32_t s2);
  ge::graphStatus processPageAttentionInputFlag(ContextParamsForInnerPFA &contextKeyParams);
  bool checkPAKeyValueDimsWhenBBH(ContextParamsForInnerPFA &contextKeyParams, int32_t keyDim1, int32_t keyDim2,
                                  int32_t keyDim3, int64_t blockNumValid, const int32_t *curBlockSize, int64_t h,
                                  int64_t headNumRatio);
  bool checkPAKeyValueDimsWhenBNBD(ContextParamsForInnerPFA &contextKeyParams, const gert::StorageShape *keyShape,
  ...
  bool checkPAKeyValueDimsWhenNZ(const ContextParamsForInnerPFA &contextKeyParams, const gert::StorageShape *keyShape,
                                 const gert::StorageShape *valueShape, int32_t keyDim1, int32_t keyDim2,
                                 int32_t keyDim3, int64_t blockNumValid, const int32_t *curBlockSize, int64_t h,
                                 int64_t n, int64_t headNumRatio);
  bool checkPABlockSizeAndBlockTable(const ContextParamsForInnerPFA &contextKeyParams,
                                     const gert::Tensor *actualSeqLenKV, const int32_t *curBlockSize, int64_t b);
  bool culActSeqLenParamsWhenPA(ContextParamsForInnerPFA &contextKeyParams, const gert::Tensor *actualSeqLenKV,
                                int64_t &blockNumValid, int32_t &maxBlockNumPerBatch, int32_t tempBlockSize,
                                const int32_t *curBlockSize, int64_t b);
  bool CheckPAKeyValueParams(ContextParamsForInnerPFA &contextKeyParams, const gert::StorageShape *keyShape,
  ...
  bool CheckPASparseMode(const ContextParamsForInnerPFA &contextKeyParams);
  bool CheckPAWhenBaseApi(ContextParamsForInnerPFA &contextKeyParams, const gert::Tensor *actualSeqLenQ,
                          const gert::Tensor *actualSeqLenKV, int64_t n, int64_t h, int64_t headNumRatio);
  bool CheckPATypeAndShape(ContextParamsForInnerPFA &contextKeyParams, const gert::Tensor *actualSeqLenKV, int32_t b,
                           int64_t n, int64_t h, int64_t headNumRatio);
  bool CheckAttenMaskShape(const ContextParamsForInnerPFA &contextKeyParams, const int32_t *sparseMode,
                           const gert::StorageShape *attenMaskShape, const uint64_t sQ, const uint64_t sK,
                           const uint32_t batchSize);
  bool CheckPAAntiquantSupportScenarios(ContextParamsForInnerPFA &contextKeyParams,
                                        InnerPromptFlashAttentionTilingData &tilingData);
  bool CheckPerchannelAntiquantParamsShape(ContextParamsForInnerPFA &contextKeyParams,
  ...
  bool CheckPerchannelBSNDParamsShape(ContextParamsForInnerPFA &contextKeyParams,
                                      const gert::StorageShape *antiquantScaleShape,
                                      const gert::StorageShape *antiquantOffsetShape, const uint64_t n,
                                      const uint32_t d, uint32_t paramFirstDim) const;
  bool CheckAntiquantParamsShape(ContextParamsForInnerPFA &contextKeyParams,
                                 const gert::StorageShape *antiquantScaleShape,
                                 const gert::StorageShape *antiquantOffsetShape, const uint64_t n, const uint32_t d,
                                 const uint64_t h, InnerPromptFlashAttentionTilingData &tilingData);
  ge::graphStatus CheckPostQuantParams(const ContextParamsForInnerPFA &contextKeyParams, uint64_t h, uint64_t n) const;
  ge::graphStatus InnerPromptFlashAttentionCVDiffSetTensorSize(InnerPromptFlashAttentionTilingData &tilingData,
                                                               PromptAttentionSingleCoreTensorSize &tensorSize,
                                                               uint32_t sOuterFactor, uint32_t sInnerFactor,
                                                               uint32_t softmaxSOuterFactor);
  bool InnerPromptFlashAttentionComputeCVDiffParams(InnerPromptFlashAttentionTilingData &tilingData, int64_t ubSize,
                                                    int64_t l1Size, int64_t l0CSize, uint32_t typeByteSize,
                                                    uint32_t &sOuterFactor, uint32_t &sInnerFactor,
                                                    uint32_t maskTypeSize, uint32_t &softmaxSOuterFactor);
  bool FindOptimalTilingBasicBLock(InnerPromptFlashAttentionTilingData &tilingData, uint32_t &sOuterFactor,
                                   uint32_t &sInnerFactor, uint32_t &softmaxSOuterFactor, int64_t ubSize,
                                   uint32_t typeByteSize, uint32_t maskTypeSize);
  bool FindOptimalTilingSouter(InnerPromptFlashAttentionTilingData &tilingData, uint32_t &sOuterFactor,
                               uint32_t &sInnerFactor, uint32_t &softmaxSOuterFactor, int64_t ubSize,
                               uint32_t typeByteSize, uint32_t maskTypeSize);
  void InferTilingMod(const ContextParamsForInnerPFA &contextKeyParams, const std::vector<int64_t> &actualSeqLengths,
  ...
  ge::graphStatus AdjustCVTiling(uint64_t hDivN, uint64_t n, int64_t middleActualSeqLengths, int64_t ubSize,
                                 ...
                                 uint32_t &sInnerFactor, InnerPromptFlashAttentionTilingData &tilingData);
  ge::graphStatus AdjustCVTilingCVDiff(int64_t ubSize, int64_t l1Size, int64_t l0CSize, uint32_t maskElemSize,
                                       ...
                                       InnerPromptFlashAttentionTilingData &tilingData);
  bool CheckSparseModeRightDown(ContextParamsForInnerPFA &contextKeyParams,
                                const std::vector<int64_t> &actualSeqLengths,
                                const std::vector<int64_t> &actualSeqLengthsKV, size_t lenDims);
  ge::graphStatus GetAndCheckEmptyQueryShape(const ContextParamsForInnerPFA &contextKeyParams,
                                             const gert::StorageShape *queryShape) const;
  void UpdateTilingKeyFlag(const ContextParamsForInnerPFA &contextKeyParams, uint64_t &tilingKey);
  int64_t InnerPromptFlashAttentionSetMsdUbSize(InnerPromptFlashAttentionTilingData &tilingData,
                                                PromptAttentionSingleCoreTensorSize &tensorSize,
                                                int32_t sInnerFactorTmp) const;
  ge::graphStatus CheckIOType(ContextParamsForInnerPFA &contextKeyParams,
                              InnerPromptFlashAttentionTilingData &tilingData, int32_t &outputDataTypeSize);
  ge::graphStatus CheckD(ContextParamsForInnerPFA &contextKeyParams) const;
  ge::graphStatus CheckDimNums(ContextParamsForInnerPFA &contextKeyParams);
  ge::graphStatus CheckMaskType(const ContextParamsForInnerPFA &contextKeyParams,
                                InnerPromptFlashAttentionTilingData &tilingData, uint32_t &maskElemSize) const;
  void SetMaskSize(const gert::StorageShape *attenMaskShape, InnerPromptFlashAttentionTilingData &tilingData) const;
  ge::graphStatus CheckShape(ContextParamsForInnerPFA &contextKeyParams, const gert::StorageShape *queryShape,
  ...
  ge::graphStatus CheckBaseAPISupportScenarios(ContextParamsForInnerPFA &contextKeyParams);
  ...
  ge::graphStatus TilingGetBaseApiTilingKeyAttentionAscendC(uint64_t &tilingKey,
                                                            const ContextParamsForInnerPFA &contextKeyParams);
  ge::graphStatus CheckBaseApiRequiredInput(ContextParamsForInnerPFA &contextKeyParams);
  ge::graphStatus CheckBaseApiOptionalInput(ContextParamsForInnerPFA &contextKeyParams);
  ge::graphStatus CheckBaseApiPse(ContextParamsForInnerPFA &contextKeyParams, const gert::StorageShape *pseShiftShape);
  void SetBaseApiTilingData(const ContextParamsForInnerPFA &contextKeyParams, std::vector<int64_t> &actualSeqLengths,
                            std::vector<int64_t> &actualSeqLengthsKV);
  void SetBaseApiSeqTilingData(const ContextParamsForInnerPFA &contextKeyParams,
                               const std::vector<int64_t> &actualSeqLengths,
                               const std::vector<int64_t> &actualSeqLengthsKV);

  ge::graphStatus CheckBaseApiMaskBasic(ContextParamsForInnerPFA &contextKeyParams,
                                        const gert::StorageShape *pseShiftShape, bool isLongSeq,
                                        uint32_t batchSize) const;
  ge::graphStatus CheckBaseApiMaskVal(ContextParamsForInnerPFA &contextKeyParams,
                                      const gert::StorageShape *pseShiftShape,
                                      const std::pair<std::vector<int64_t>, std::string> maskShape) const;
  ge::graphStatus CheckBaseApiAlibiMask(ContextParamsForInnerPFA &contextKeyParams,
                                        const gert::StorageShape *pseShiftShape, uint32_t batchSize, int32_t maxSeqLen,
                                        int32_t maxKvSeqLen, uint32_t kvHead, bool compressHead) const;
  ge::graphStatus CheckBaseApiNormMask(ContextParamsForInnerPFA &contextKeyParams,
  ...
  ge::graphStatus SetBaseApiPseInfo(const ContextParamsForInnerPFA &contextKeyParams,
                                    const gert::StorageShape *pseShiftShape);
  void SetBaseApiOtherMaskInfo(const ContextParamsForInnerPFA &contextKeyParams,
                               const gert::StorageShape *pseShiftShape);
  ge::graphStatus SetBaseApiAlibiMaskInfo(const ContextParamsForInnerPFA &contextKeyParams,
                                          const gert::StorageShape *pseShiftShape);
  ge::graphStatus AtbSplitBlock(const ContextParamsForInnerPFA &contextKeyParams);
  ...
  ge::graphStatus CheckInputShapeWhenLayoutIsTND(ContextParamsForInnerPFA &contextKeyParams) const;
  ge::graphStatus CheckActSeqWhenLayoutIsTND(ContextParamsForInnerPFA &contextKeyParams) const;

  ge::graphStatus CheckVarLenPreNextToken(ContextParamsForInnerPFA &contextKeyParams, int32_t sparseMode,
                                          int64_t sparsePreTokens, int64_t sparseNextTokens);
  ge::graphStatus CheckLearnableSinkWhenLayoutIsTND(const ContextParamsForInnerPFA &contextKeyParams) const;

 protected:
  ContextParamsForInnerPFA *contextKeyParamsPtr = nullptr;
  ...
  uint32_t tmpS2 = 0;  // In the PA scenario, there is no S2 axis. Use the change amount to normalize the S2 length in
                       // both PA and non PA scenarios
  ...
  bool isSameAB = true;
  InnerPromptFlashAttentionBaseApiTilingData baseApiTilingData;
  MLAGeneralTilingData mlaTilingData;
};
// end of class InnerPromptFlashAttention
PFA_EXTERN_C ge::graphStatus TilingInnerPromptFlashAttention(gert::TilingContext *context);
}  // namespace optiling
