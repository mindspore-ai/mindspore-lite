...
/*!
 * \file inner_prompt_flash_attention_tiling_context.h
 * \brief
 */
#ifndef INNER_PROMPT_FLASH_ATTENTION_TILING_CONTEXT_H
#define INNER_PROMPT_FLASH_ATTENTION_TILING_CONTEXT_H
...
*/
struct ContextParamsForInnerPFA {
  ...
  const InnerPromptFlashAttentionCompileInfo *compileInfoPtr = nullptr;
...
#endif  // INNER_PROMPT_FLASH_ATTENTION_TILING_CONTEXT_H
