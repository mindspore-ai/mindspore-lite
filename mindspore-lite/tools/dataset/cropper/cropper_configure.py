...
MINDSPORE_LOCATION = "mindspore"

# needed for gcc command for include directories
MANUAL_HEADERS = [
    ".",
    f"{MINDSPORE_LOCATION}/mindspore",
    f"{MINDSPORE_LOCATION}/mindspore/ccsrc",
    f"{MINDSPORE_LOCATION}/mindspore/ccsrc/minddata/dataset",
    f"{MINDSPORE_LOCATION}/mindspore/ccsrc/minddata/dataset/kernels/image",
    f"{MINDSPORE_LOCATION}/mindspore/core",
    f"{MINDSPORE_LOCATION}/mindspore/core/include",
    "mindspore-lite",
]
...
EXTERNAL_DEPS = [
    ...
    "build/_deps/icu4c-src/icu4c/source/i18n",
    "build/_deps/icu4c-src/icu4c/source/common",
    "build/_deps/tinyxml2-src",
    "build/_deps/jpeg_turbo-src",
    "build/_deps/jpeg_turbo-src/_build",
...
DATASET_PATH = f"{MINDSPORE_LOCATION}/mindspore/ccsrc/minddata/dataset"
