...
getCommonFile() {
  ...
  others_files_h=(
    ...
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/infer/infer_register.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/nnacl_utils.h
    "${MINDSPORE_LITE_HOME}"/src/common/ops/populate/populate_register.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/op_base.h
    ...
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/intrinsics/ms_simd_instructions.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/intrinsics/ms_simd_instructions_fp16.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/infer/infer.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/infer/common_infer.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/tensor_c.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/errorcode.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/common_func.h
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/tensor_c_utils.h
  ...
  assembly_files=()
  while IFS='' read -r line; do assembly_files+=("$line"); done < <(ls ${MINDSPORE_LITE_HOME}/src/litert/kernel/cpu/nnacl_c/assembly/*/*.S)
  others_files_c=(
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/nnacl_utils.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/errorcode.c
    ...
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/infer/infer_register.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/infer/shape_fusion_infer.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/infer/common_infer.c
    ...
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/kernel.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/tensor_c_utils.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/tensorlist_c_utils.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/base/format_transpose.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/base/cast_base.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/fp32/transpose_fp32.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/fp32/pack_fp32.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/fp16/pack_fp16.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/fp32/pack_fp32_opt.c
    "${MINDSPORE_LITE_HOME}"/src/litert/kernel/cpu/nnacl_c/nnacl_common.c
  )
...
getOpsFile "REG_INFER\(.*?, PrimType_" "${MINDSPORE_LITE_HOME}/src/litert/kernel/cpu/nnacl_c/infer" "prototype" &
# support for cpu
...
getNnaclKernelFile "REG_KERNEL_CREATOR\(PrimType_" "${MINDSPORE_LITE_HOME}/src/litert/kernel/cpu/nnacl_c/kernel" "kNumberTypeFloat32" "kNumberTypeFloat32" &
getNnaclKernelFile "REG_KERNEL_CREATOR\(PrimType_" "${MINDSPORE_LITE_HOME}/src/litert/kernel/cpu/nnacl_c/kernel" "kNumberTypeFloat16" "kNumberTypeFloat16" &
getNnaclKernelFile "REG_KERNEL_CREATOR\(PrimType_" "${MINDSPORE_LITE_HOME}/src/litert/kernel/cpu/nnacl_c/kernel" "kNumberTypeInt8" "kNumberTypeInt8" &
getNnaclKernelFile "REG_KERNEL_CREATOR\(PrimType_" "${MINDSPORE_LITE_HOME}/src/litert/kernel/cpu/nnacl_c/kernel" "kNumberTypeInt32" "kNumberTypeInt32" &
getNnaclKernelFile "REG_KERNEL_CREATOR\(PrimType_" "${MINDSPORE_LITE_HOME}/src/litert/kernel/cpu/nnacl_c/kernel" "kNumberTypeInt32" "kNumberTypeBool" &
